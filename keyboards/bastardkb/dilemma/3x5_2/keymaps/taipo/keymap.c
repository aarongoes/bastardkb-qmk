...
[0] = LAYOUT_split_3x5_2(
    KC_R,   KC_S,   KC_N,   KC_I,     XX,   XX,     KC_I,   KC_N,   KC_S,   KC_R,
    KC_A,   KC_O,   KC_T,   KC_E,     XX,   XX,     KC_E,   KC_T,   KC_O,   KC_A,
...
const uint16_t PROGMEM CM105[] = {KC_O,KC_N,KC_I,COMBO_END};
const uint16_t PROGMEM CM106[] = {KC_O,KC_N,KC_I,KC_SPC,COMBO_END};
const uint16_t PROGMEM CM107[] = {KC_O,KC_N,KC_I,KC_BSPC,COMBO_END};
const uint16_t PROGMEM CM108[] = {KC_O,KC_N,KC_I,KC_SPC,KC_BSPC,COMBO_END};
const uint16_t PROGMEM CM109[] = {KC_A,KC_O,KC_T,COMBO_END};
const uint16_t PROGMEM CM110[] = {KC_A,KC_O,KC_T,KC_SPC,COMBO_END};
const uint16_t PROGMEM CM111[] = {KC_A,KC_O,KC_T,KC_BSPC,COMBO_END};
const uint16_t PROGMEM CM112[] = {KC_R,KC_S,KC_N,COMBO_END};
const uint16_t PROGMEM CM113[] = {KC_R,KC_S,KC_N,KC_SPC,COMBO_END};
const uint16_t PROGMEM CM114[] = {KC_R,KC_S,KC_N,KC_BSPC,COMBO_END};
...
combo_t key_combos[] = {
	...
	COMBO(CM109,DRGSCRL),
	COMBO(CM110,DPI_MOD),
	COMBO(CM111,DPI_RMOD),
	COMBO(CM112,SNIPING),
	COMBO(CM113,S_D_MOD),
	COMBO(CM114,S_D_RMOD)
};
